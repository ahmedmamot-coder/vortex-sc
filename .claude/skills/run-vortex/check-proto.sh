...
# {{ binding }} have a prop behind it? The ~224 "unbound" on a clean tree are props built by
# spread rather than a literal key — compare against that baseline, not against zero.
#
