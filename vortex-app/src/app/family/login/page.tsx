...
export default function FamilyLoginPage() {
  ...
  return (
    ...
    >
      ...
      <h1 className="text-2xl font-bold text-white mb-1">Parent / swimmer sign in</h1>
      <p className="text-[var(--vx-slate-300)] mb-8 text-sm">
        View performance, attendance, results &amp; meets
      </p>
      ...
      <Link href="/family/register" className="mt-8 text-sm text-[var(--vx-slate-300)] underline">
        New here? Register
      </Link>
    </div>
  );
